...
{
    /// <inheritdoc />
    public partial class UpdateStockOverviewWithProductGroupsAndShoppingLocations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // =========================================================================
            // UPDATE PHASE 1 VIEW: uihelper_stock_current_overview
            // =========================================================================
            //
            // Updates the stock overview view to use actual product_groups and
            // shopping_locations tables instead of returning NULL.
            //
            // Changes:
            // - product_group_name: NULL → pg.name (JOIN to product_groups)
            // - default_store_name: NULL → sl.name (JOIN to shopping_locations)
            //
            // Note: on_shopping_list remains false until shopping_list table is created in Batch 2
            //
            // =========================================================================
            ...
            migrationBuilder.Sql(@"
                ...
                /*
                    ...
                    Updated: Now uses actual product_groups and shopping_locations tables
                */
                SELECT
                    p.id,
                    ...
                    pg.name AS product_group_name, -- ✅ Now uses actual product_groups table
                    sl.name AS default_store_name, -- ✅ Now uses actual shopping_locations table
                    false AS on_shopping_list, -- ⏳ Will use shopping_list table in Batch 2
            ...
            // =========================================================================
            //
            // ✅ uihelper_stock_current_overview now returns actual data for:
            //    - product_group_name (from product_groups table)
            //    - default_store_name (from shopping_locations table)
            //
            // ⏳ Still returns false for on_shopping_list (shopping_list table in Batch 2)
            //
            // Phase 1 views are now fully functional with Phase 2 Batch 1 tables!
            //
            // =========================================================================
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Recreate original version with NULLs
            migrationBuilder.Sql(@"
                CREATE VIEW uihelper_stock_current_overview AS
                SELECT
                    p.id,
