...
namespace Famick.HomeManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260219155405_AddTermsAcceptanceToUser")]
    partial class AddTermsAcceptanceToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.Contact", b =>
                {
                    ...
                    b.Property<bool>("IsTenantHousehold")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("UsesGroupAddress")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("TenantId", "IsTenantHousehold")
                        .IsUnique()
                        .HasFilter("\"IsTenantHousehold\" = true");

                    b.HasIndex("TenantId", "LinkedUserId");

                    b.HasIndex("TenantId", "ParentContactId");
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipeImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipeNesting", b =>
                {
                    ...
                    b.ToTable("recipe_nestings", (string)null);
                });
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipePosition", b =>
                {
                    ...
                    b.Property<bool>("NotCheckStockFulfillment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("OnlyCheckSingleUnitInStock")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.ToTable("recipe_positions", (string)null);
                });

            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipeShareToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipeStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ImageExternalUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<int>("StorageBlocksPurchased")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.Contact", b =>
                {
                    ...
                    b.HasOne("Famick.HomeManagement.Domain.Entities.Contact", "ParentContact")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.Recipe", b =>
                {
                    b.HasOne("Famick.HomeManagement.Domain.Entities.Contact", "CreatedByContact")
                        .WithMany()
                        .HasForeignKey("CreatedByContactId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("CreatedByContact");
                });
            ...
            modelBuilder.Entity("Famick.HomeManagement.Domain.Entities.RecipePosition", b =>
                {
                    ...
                    b.HasOne("Famick.HomeManagement.Domain.Entities.RecipeStep", "RecipeStep")
